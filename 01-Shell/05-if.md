# Bash If Statements
> If statements in Bash control the flow of a script by executing different blocks of commands based on whether a condition is true or false. They support file tests, numeric comparisons, string comparisons, and logical operators.
