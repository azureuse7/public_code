...
- Horizontal would increase number of pods to meet demands 
...
Basically when the pod reaches 20% its needs to incase the pod, let see 

## Step-04: Create the load & Verify how HPA is working
```
# Generate Load (new Terminal) this will run the load make 50000 requests (hpa-demo is the service we creatd)
