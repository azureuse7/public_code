...
> S3 is AWS's object storage service — store and retrieve any amount of data at any time. Known for 99.999999999% (11 nines) durability, it is used for backups, static website hosting, data lakes, and application asset storage.
