...
#   source    = "github.com/gagan-thakur786/terraform-module1/01-modules-call-web/storage-account"
# }

# Create resource group from remote git
# module "storage_account3" {
#   source    = "github.com/gagan-thakur786/terraform-module1"
#  }

#Create resource group from remote git using feature branch
# module "storage_account3" {
#   source    = "github.com/gagan-thakur786/terraform-module1?ref=main"
# }

#Create resource group from remote git using tag (just to prove it change version from 4 to 3)
# module "storage_account3" {
#   source    = "github.com/gaganthakur786/terraform-module1?ref=v.04"
# }
